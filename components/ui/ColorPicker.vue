<template>
  <div class="border border-stroke min-w-min w-min rounded-lg bg-bg">
    <div class="p-4 w-60">
      ...
      <div class="flex items-center">
        <div v-show="inputType === 'rgba'" class="flex">
          <div>
            ...
            <input v-model="colorLazy.r" @input="inputUpdated" @blur="blurInputR" class="shadow appearance-none border border-stroke rounded text-center w-10 h-8 text-grayscale-900 bg-primary" />
          </div>
          <div class="mx-1">
            <p class="text-center text-gray-500 text-sm">G</p>
            <input v-model="colorLazy.g" @input="inputUpdated" @blur="blurInputG" class="shadow appearance-none border border-stroke rounded text-center w-10 h-8 text-grayscale-900 bg-primary" />
          </div>
          <div class="mr-1">
            <p class="text-center text-gray-500 text-sm">B</p>
            <input v-model="colorLazy.b" @input="inputUpdated" @blur="blurInputB" class="shadow appearance-none border border-stroke rounded text-center w-10 h-8 text-grayscale-900 bg-primary" />
          </div>
          <div>
            <p class="text-center text-gray-500 text-sm">A</p>
            <input v-model="colorLazy.a" @input="inputUpdated" @blur="blurInputA" class="shadow appearance-none border border-stroke rounded text-center w-10 h-8 text-grayscale-900 bg-primary" />
          </div>
        </div>
        <div v-show="inputType === 'hexa'" class="mr-3">
          <p class="text-gray-500 text-center text-sm">HEXA</p>
          <input v-model="colorLazy.hexa" @input="hexaInputUpdated" @blur="blurInputHexa" class="shadow appearance-none border border-stroke rounded text-center w-40 h-8 text-grayscale-900 bg-primary" />
        </div>
