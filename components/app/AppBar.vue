<template>
  <div id="appbar" class="fixed top-0 left-0 w-screen flex items-center h-16 sm:h-20 px-4 md:px-8 bg-bg border-b border-grayscale-400 shadow-sm z-10">
    ...
    <div class="md:w-80 md:min-w-80 px-2 h-full">
      ...
      <div v-else class="h-full flex items-center justify-end">
        <button class="outline-none mx-3 hidden sm:flex"><span class="material-icons-outlined text-2xl">bookmark_border</span></button>
